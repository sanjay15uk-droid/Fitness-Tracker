...
2. Upload these five files to the repo root: `index.html`, `style.css`, `app.js`, `data.js`, `README.md`. Easiest from a phone: on the repo page tap **Add file → Upload files**, pick all five, commit.
